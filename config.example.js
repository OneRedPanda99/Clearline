...
window.CL_SECRETS = {
    ...
    // Cloud Functions region for callables (receipt OCR, Twilio SMS, Hermes).
    // Must match where you deploy `functions/`. Secrets for Gemini/Twilio/
    // OpenRouter live ONLY in Functions env — never here.
